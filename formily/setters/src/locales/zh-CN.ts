const ValidatorFormats = [
  ...
  { label: '通用-拼音码/五笔码/助记符', value: 'wbPyInputStr' },
  { label: '通用-编码', value: 'cd' },
];
  ...
  'zh-CN': {
    settings: {
      'x-validator': {
        ...
        max: '长度/数值最大值',
        min: '长度/数值最小值',
        exclusiveMaximum: '长度/数值小于',
        exclusiveMinimum: '长度/数值大于',
        whitespace: '不允许空白符',
        required: '是否必填',
        message: {
          title: '错误消息',
    ...
    SettingComponents: {
      ...
      ReactionsSetter: {
        ...
        buttonReactions: '配置事件',
        buttonDescribe: '点击事件响应(高级，可选，支持JS语句)',
      },
      ValidatorSetter: {
        pleaseSelect: '请选择',
