...
export class Keyboard {
  ...
  modifiers = {};
  requestTimer = null;
  isKeyboardEventActive: boolean;

  constructor(engine?: Engine) {
    this.engine = engine;
    this.shortcuts = engine.props?.shortcuts || [];
    this.isKeyboardEventActive = true;
    this.makeObservable();
  }
  ...
  switchKeyboardEventEffect(active: boolean) {
    this.isKeyboardEventActive = active;
  }
