...
import { TextWidget, IconWidget, usePrefix, useTheme } from '@astraflux/low-code-react';
import { Tooltip } from 'antd';
import { parseExpression, parse } from '@babel/parser';
import { uid } from '@astraflux/low-code-shared';
  ...
  const renderHelpCode = () => {
    ...
    return (
      <div
        ...
        style={{ width: helpCodeViewWidth || '30%' }}
      >
        <Editor
          value={helpCode}
