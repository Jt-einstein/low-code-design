...
import { isStr, isPlainObj } from '@astraflux/low-code-shared';
import { GlobalRegistry, IDesignerMiniLocales } from '@astraflux/low-code-core';
...
export const TextWidget: React.FC<ITextWidgetProps & { children?: ReactNode }> =
  observer((props) => {
    const takeLocale = (
